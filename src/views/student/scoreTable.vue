<template>
  <div class="app-container">
    ...
    <el-table
      ...
      style="width: 100%;"
    >
      <el-table-column label="身份证号" prop="idNumber" sortable align="center">
      ...
      <el-table-column prop="currentTime" sortable label="开始考试时间" align="center" width="170">
        <template slot-scope="scope">
          <span>{{ scope.row.currentTime | date-format }}</span>
        </template>
      </el-table-column>
    ...
    methods: {
      ...
      handleDownload(){
        ...
        import('@/vendor/Export2Excel').then(excel => {
          const tHeader = ['身份证号', '姓名', '试卷名称', '考试分数', '开始考试时间', '提交考卷时间', '花费时间']
          const filterVal = ['idNumber', 'peoplename', 'paperName', 'score', 'currentTime', 'endTime', 'timeUsed']
